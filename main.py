...
def basic_using():
    ...
    middle_path = r"workspace\alsj\source_images"

    # 1. 添加两幅图片，分别设置不同的播放时间
    image1_full_name = r"E:\work\AItools\workspace\alsj\source_images\subtitle_0004.jpg" #os.path.join(root_path, middle_path, "subtitle_0004.jpg")
    image2_full_name = r"E:\work\AItools\workspace\alsj\source_images\subtitle_0003.jpg" #os.path.join(root_path, middle_path, "subtitle_0006.jpg")
    

    draft.add_media(image1_full_name,duration=5_000_000)  # 图片如果不指定duration，默认播放5秒
    draft.add_media(image2_full_name, duration=4_000_000)  # 指定图片播放时长为4秒
    draft.add_subtitle("我喜欢你，小小", duration=4_000_000)
    draft.add_subtitle("请接收我的爱意", duration=4_000_000)
    draft.add_media(r"C:\Users\Administrator\Desktop\歌曲\111.mp3")
